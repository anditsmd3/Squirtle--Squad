...
export default function SquirtleSquadWebsite() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#53ccf2] to-[#3a95b0] overflow-hidden">
      <style jsx global>{`
        ...
        .water-ripple {
          background: linear-gradient(to right, #53ccf2, #3a95b0);
      ...
      <header className="bg-[#53ccf2] fixed top-0 left-0 right-0 z-50 border-b-4 border-[#f6f09f]">
        <nav className="container mx-auto px-4 py-4">
          <ul className="flex justify-center space-x-6 text-xs">
            <li><a href="#about" onClick={(e) => { e.preventDefault(); scrollToSection('about'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">About</a></li>
            <li><a href="#why-pulse" onClick={(e) => { e.preventDefault(); scrollToSection('why-pulse'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">Why Pulse</a></li>
            <li><a href="#our-vision" onClick={(e) => { e.preventDefault(); scrollToSection('our-vision'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">Our Vision</a></li>
            <li><a href="#pokenomics" onClick={(e) => { e.preventDefault(); scrollToSection('pokenomics'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">Pokénomics</a></li>
            <li><a href="#roadmap" onClick={(e) => { e.preventDefault(); scrollToSection('roadmap'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">Roadmap</a></li>
            <li><a href="#how-to-buy" onClick={(e) => { e.preventDefault(); scrollToSection('how-to-buy'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">How to Buy</a></li>
            <li><a href="#community" onClick={(e) => { e.preventDefault(); scrollToSection('community'); }} className="text-white hover:text-[#f6f09f] transition-colors duration-300">Community</a></li>
          </ul>
        </nav>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 mt-24">
        ...
        <section id="hero" className="mb-16 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] border-4 border-[#f6f09f] rounded-lg p-6 section-hover water-ripple">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-1/2">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-lg">
                Join the Squirtle Squad!
              </h1>
              <p className="text-lg text-[#f6f09f] mb-6 drop-shadow">
              ...
              <div className="flex flex-wrap gap-4">
                <Button variant="default" size="lg" className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white transition-all duration-300">
                  Join the Squad
                </Button>
                <Button variant="outline" size="lg" className="bg-white text-blue-600 hover:bg-blue-100 transition-all duration-300">
                  Buy on PulseX
                </Button>
                <Button variant="ghost" size="lg" className="text-white hover:bg-blue-600 transition-all duration-300">
                  Learn More
        ...
        <section id="about" className="mb-16 bg-black border-4 border-[#f6f09f] rounded-lg p-6 section-hover">
          ...
          <p className="text-[#f6f09f] mb-4 text-sm leading-relaxed">
          ...
          <p className="text-[#f6f09f] text-sm leading-relaxed">
        ...
        <section id="why-pulse" className="mb-16 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] border-4 border-[#f6f09f] rounded-lg p-6 section-hover water-ripple">
        ...
        <section id="pokenomics" className="mb-16 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] border-4  border-[#f6f09f] rounded-lg p-6 section-hover water-ripple">
          <h2 className="text-3xl font-bold text-white mb-4">Pokénomics</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            <div className="flex flex-col items-center">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/5807558493530604422%20(2)-sIOVynMHHLgzYHTn5HtGdW5P733upH.jpg" alt="Total Supply" className="w-48 h-48 object-cover rounded-full mb-4 border-4 border-[#f6f09f]" />
              <h3 className="text-xl font-bold text-white mb-2">Total Supply</h3>
              <p className="text-[#f6f09f] text-center text-xs">4,206,942,069 $SQUAD</p>
              <p className="text-[#f6f09f] text-center text-xs mt-2">Because we know 69 and 420 are more than just numbers—they're a way  of life!</p>
            </div>
            <div className="flex flex-col items-center">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/5807558493530604421-FMmjuek2LrJhgYKdj14NMsxZO0dvjm.jpg" alt="Burned" className="w-48 h-48 object-cover rounded-full mb-4 border-4 border-[#f6f09f]" />
              <h3 className="text-xl font-bold text-white mb-2">Burned (75%)</h3>
              <p className="text-[#f6f09f] text-center text-xs">"Straight to the Shell!"</p>
              <p className="text-[#f6f09f] text-center text-xs mt-2">Three quarters of the total supply has been sent to the burn address.</p>
            </div>
            <div className="flex flex-col items-center">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/5807558493530604425%20(1)-xZ2ph4BmM3OzXSE9a9vrQElbZvGGrz.jpg" alt="Liquidity Pool" className="w-48 h-48 object-cover rounded-full mb-4 border-4 border-[#f6f09f]" />
              <h3 className="text-xl font-bold text-white mb-2">Liquidity Pool (22.5%)</h3>
              <p className="text-[#f6f09f] text-center text-xs">"Shell Shocked & Ready"</p>
              <p className="text-[#f6f09f] text-center text-xs mt-2">22.5% of the supply is locked into the Liquidity Pool.</p>
            </div>
            <div className="flex flex-col items-center">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/5807558493530604427%20(1)-22hs6W2sLSzqDXlHrgd13OggJPc5d6.jpg" alt="Community Fund" className="w-48 h-48 object-cover rounded-full mb-4 border-4 border-[#f6f09f]" />
              <h3 className="text-xl font-bold text-white mb-2">Community Fund (2.5%)</h3>
              <p className="text-[#f6f09f] text-center text-xs">"Squad Goals Fund"</p>
              <p className="text-[#f6f09f] text-center text-xs mt-2">2.5% is set aside for our Squirtle Squad community.</p>
            </div>
            <div className="flex flex-col items-center">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/7_squirtle__use_water_gun___by_jtgo_dad0tet-pre-HrsixHa2gcUHZveaqTOoCoONESsOk2.jpg" alt="WATER PULSE" className="w-48 h-48 object-cover rounded-full mb-4 border-4 border-[#f6f09f]" />
              <h3 className="text-xl font-bold text-white mb-2">WATER PULSE</h3>
              <p className="text-[#f6f09f] text-center text-xs">Squirtle's Best Move</p>
              <p className="text-[#f6f09f] text-center text-xs mt-2">Buys and Burns SQUAD, rewards holders with SQUAD dividends and automatically grows the Liquidity Pool. Refreshing!</p>
            </div>
          </div>
        </section>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              <div className="relative">
                ...
                <div className="ml-8 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] p-4 rounded-lg">
                  <h3 className="text-2xl font-semibold text-white mb-2">Phase 1: Assemble the Squad</h3>
                  <ul className="list-disc list-inside text-[#f6f09f] text-xs space-y-2">
        ...
        <section id="how-to-buy" className="mb-16 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] border-4 border-[#f6f09f] rounded-lg p-6 section-hover water-ripple">
          <h2 className="text-3xl font-bold text-white mb-4">Join the Squad in 3 Simple Steps!</h2>
          <ol className="list-decimal list-inside text-[#f6f09f] space-y-4 text-sm">
            <li>
              <strong>Download Rabby to get instant access to Pulsechain</strong>
              <p className="ml-6 mt-2">Download the Rabby wallet and connect it to Pulsechain.</p>
            </li>
            <li>
              <strong>Fund Your Wallet</strong>
              <p className="ml-6 mt-2">Get some PLS (Pulse's native coin) and transfer it to your wallet. This will be used to swap for $SQUAD.</p>
            </li>
            <li>
              <strong>Buy $SQUAD on PulseX</strong>
              <p className="ml-6 mt-2">Head over to PulseX, connect your wallet, and trade PLS for $SQUAD. Welcome to the Squad!</p>
            </li>
          </ol>
        </section>
        ...
        <section id="pokechain" className="mb-16 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] border-4 border-[#f6f09f] rounded-lg p-6 section-hover water-ripple">
        ...
        <section id="safety" className="mb-16 bg-black border-4 border-[#f6f09f] rounded-lg p-6 section-hover">
          ...
          <ul className="list-disc list-inside text-[#f6f09f] space-y-2 text-sm">
            <li>
          ...
          <p className="text-[#f6f09f] mt-4 text-sm leading-relaxed">
            Join the Squirtle Squad, where your investments are as secure as a Squirtle in its shell!
          </p>
        </section>

        <section id="faq" className="mb-16 bg-gradient-to-r from-[#53ccf2] to-[#3a95b0] border-4 border-[#f6f09f] rounded-lg p-6 section-hover water-ripple">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-[#f6f09f] text-sm leading-relaxed">$SQUAD is a memecoin inspired by the legendary Squirtle Squad from Pokémon. It's built on the Pulse blockchain and part of the Pokéchain ecosystem.</p>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-white">How can I buy $SQUAD?</h3>
              <p className="text-[#f6f09f] text-sm leading-relaxed">You can buy $SQUAD using PLS on PulseX. Follow the steps in our "How to Buy" section to get started.</p>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-white">Why is $SQUAD on Pulse and not Ethereum/BSC?</h3>
              <p className="text-[#f6f09f] text-sm leading-relaxed">Pulse offers fast, low-fee transactions, which are ideal for memecoins like $SQUAD. Plus, Pulse is becoming the home of the Pokéchain ecosystem, where all Pokémon-inspired coins are coming together.</p>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-white">What can I do with $SQUAD?</h3>
              <p className="text-[#f6f09f] text-sm leading-relaxed">Besides joining an epic community, you can earn rewards, participate in contests, buy exclusive NFTs, and hold $SQUAD to help grow the memecoin on Pulse.</p>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="bg-blue-800 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xs">© 2024 Squirtle Squad. All rights reserved.</p>
        </div>
      </footer>

      <div className="fixed bottom-0 left-0 right-0 bg-[#53ccf2] border-t-4 border-[#f6f09f] p-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="text-[#f6f09f] font-bold text-xs">Hydro Pump Hits</div>
          ...
          <div className="text-[#f6f09f] text-xs">
